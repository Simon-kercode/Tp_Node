...
exports.validateProduitMiddleware = (req, res, next) => {
    ...
    if (req.body.nom && req.body.nom !== undefined && (typeof req.body.nom !== 'string' || req.body.nom.trim().length < 2 || req.body.nom.trim().length > 100)) {
        return res.status(400).json({ message: "Nom invalide. Il doit contenir entre 2 et 100 caractères." });
    }

    if (req.body.prix && req.body.prix !== undefined) {
    ...
    if (req.body.description && req.body.description !== undefined && (typeof req.body.description !== 'string')) {
